        ...
        <header className="sticky top-0 z-10 bg-white/90 backdrop-blur-sm border-b border-gray-100 shadow-sm">
          <div className="max-w-4xl mx-auto px-4 h-16 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl font-semibold text-gray-800">Mindful Journal</h1>
            </div>
        ...
        <main className="max-w-4xl mx-auto px-4 py-8">
          <div className="mb-6 text-center">
            <p className="text-gray-600">
              Each session is a complete journaling conversation. Switch between sessions or start a new one anytime.
            </p>
          </div>
          ...
          <div className="max-w-lg w-full">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed max-w-md mx-auto">
                Your AI-powered journaling companion. Each session is a complete conversation 
                where you can reflect, grow, and discover insights about yourself.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-10 mb-8">
              <div className="mb-6 text-center">
                ...
                <p className="text-gray-600 text-sm">Sign in to continue your journaling journey</p>
              </div>
              <SignInForm />
            </div>
